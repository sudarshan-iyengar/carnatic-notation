...
export const HeadingBlock = ({ block, printHidden, onUpdate, onRemove, onInsertAfter }: HeadingBlockProps) => (
  <div className={`heading-block block-container relative w-full mb-8 bg-gray-50 rounded py-1 print:bg-transparent ${printHidden ? 'print-hidden-block' : ''}`}>
    <input
      type="text"
